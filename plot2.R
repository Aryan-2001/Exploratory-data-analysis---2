...
abline(h = mean(y_2005) , lwd = 4 , lty = 2,col="green")
...
title(main ="Baltimore PM 2.5 across years")
dev.off()

##you can see mean is first decreses from 1999-2002 then increases 2002-2005 and then is almost constant in 2008